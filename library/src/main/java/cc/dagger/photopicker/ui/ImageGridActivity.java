package cc.dagger.photopicker.ui;
...
import cc.dagger.photopicker.ImageDataSource;
import cc.dagger.photopicker.ImagePicker;
import cc.dagger.photopicker.R;
import cc.dagger.photopicker.Utils;
import cc.dagger.photopicker.adapter.ImageFolderAdapter;
import cc.dagger.photopicker.adapter.ImageGridAdapter;
import cc.dagger.photopicker.bean.ImageFolder;
import cc.dagger.photopicker.bean.ImageItem;
import cc.dagger.photopicker.util.ScreenUtils;
...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageGridAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DisplayMetrics dm = ScreenUtils.getScreenPix(this);
